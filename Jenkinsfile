pipeline {
    ...
    environment {
        registry = 'tarun0127/sentiment-analysis'
    ...
    stages {
        ...
        stage('Stage 4: Docker image - frontend') {
            ...
            steps {
                ...
                script {
                    frontend_docker_image = docker.build("tarun0127/sentiment_analyzer_frontend:latest", "./frontend")
                }
            }
        }
        ...
        stage('Stage 5: Docker image - backend') {
            steps {
                script {
                    backend_docker_image = docker.build("tarun0127/sentiment_analyzer_backend:latest", "./backend")
                }
            }
        }
